    ...
    return (
        <div>
            <header className="flex justify-between items-center p-2">
                ...
                <div  className="grid grid-cols-2 gap-2">
                    <Button variant="primary" onClick={()=> {  ipcRenderer.send('toggle-app'); }}>Toggle</Button>
                    <Button variant="secondary" onClick={()=> {  ipcRenderer.send('exit-app'); }}>Exit</Button>
                </div>
            </header>
            ...
            <main className="flex justify-between items-center p-4">
                ...
                <div className="grid grid-cols-8 gap-2 w-3/5">
                    ...
                    <SpacerKey/>
                    <Key keyId={3} highlighted={hightlightedKey === 3}>5</Key>
                    <Key keyId={7} highlighted={hightlightedKey === 7}>6</Key>
                    <Key keyId={11} highlighted={hightlightedKey === 11}>7</Key>
                    <Key keyId={16} highlighted={hightlightedKey === 16}>8</Key>
                    <SpacerKey/>
                    ...
                    <div className="row-start-4 row-span-2 col-start-7 col-span-2">
                        <Joystick keyId={24}/>
                    </div>
